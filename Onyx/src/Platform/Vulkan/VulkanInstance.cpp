...
namespace Onyx {
	...
	Onyx::SwapChainSupportDetails VulkanInstance::querySwapChainSupport(VkPhysicalDevice device)
	{
	...
	Onyx::QueueFamilyIndices VulkanInstance::findQueueFamilies(VkPhysicalDevice device)
	{
